...
function main(input) {
  ...
  if (!dataRead.ok) {
    process.stdout.write(dataRead.missing ? "\u26A0 pokemon: data.json absent \u2014 lance `npx claude-pokemon install`" : "\u26A0 pokemon: data.json corrompu \u2014 r\xE9pare-le ou relance `npx claude-pokemon install`");
    return;
  }
