...
`, color, RESET6);
  ...
  switch (sub) {
    case "invite": {
      ...
      if (!id) {
        msg("live.invite_failed", DIM6, JSON.stringify(resp));
        break;
      }
      setLast(id);
      out2 += bashPrintf(`
...
`, DIM6, RESET6);
    ...
    case "accept": {
      ...
      if (resp.state !== "active") {
        msg("live.accept_failed", DIM6, JSON.stringify(resp));
        break;
      }
      setLast(id);
      out2 += bashPrintf(`
...
`, DIM6, RESET6);
    ...
    case "attack": {
      ...
      if (resp.error) {
        msg("live.move_failed", DIM6, resp.error);
        break;
      }
      out2 += bashPrintf(`
...
`, GOLD6, RESET6);
    ...
    case "abandon": {
      ...
      msg("live.forfeited", DIM6, resp.state ?? "");
      break;
    }
    default:
...
`, color, RESET7);
  ...
  switch (sub) {
    ...
    case "rotate": {
      ...
      if (!newSec) {
        line("arena.regen_failed", DIM7, JSON.stringify(resp));
        break;
      }
    ...
    case "list": {
      ...
      for (const o of resp.opponents ?? []) {
        ...
        out2 += bashPrintf("  %s#%s%s  %s  Lv.%s  %s%s\n", DIM7, o.anon_id, RESET7, lineageEmoji(o.lineage), o.level, o.display_name ?? o.anon_id, shinyMark);
      }
      out2 += bashPrintf(`
...
`, DIM7, RESET7);
    ...
    case "fight": {
      ...
      if (!battleId) {
        line("arena.challenge_failed", DIM7, JSON.stringify(resp));
        break;
      }
...
`, BOLD7, GOLD7, RESET7);
      ...
      if (!code) {
        line("pair.failed", DIM7, JSON.stringify(resp));
        break;
      }
...
`, DIM7, RESET7);
      ...
      if (!newAnon || !newSecret) {
        out2 += bashPrintf(`  %s${L("link.failed", JSON.stringify(resp))}%s
